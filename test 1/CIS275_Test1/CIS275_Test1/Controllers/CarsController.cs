...
namespace CIS275_Test1.Controllers
{
    ...
    public class CarsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CarID,Make,Model,Year,Mileage,Price,DealershipID")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CarID,Make,Model,Year,Mileage,Price,DealershipID")] Car car)
        {
            if (ModelState.IsValid)
            {
